...
export default function GameList(
	...
	return data.map((val: Game) => {
      ...
      >
        <div className=" flex flex-1  gap-5">
          <div className=" flex justify-center items-center">
            <Image
              ...
              alt="team logo"
            />
            <p className=" text-xl font-semibold">{val.teamOne.teamName}</p>
          </div>
        </div>
        <div className="  flex items-center justify-center  ">
          <p className=" text-3xl font-bold">{val.teamOneScore}</p>
        </div>

        <div className=" flex flex-1 flex-col justify-center items-center">
          <p className=" text-2xl text-center">VS</p>
          <p className=" text-center">
            {val.gameDate} {val.gameTime}
          </p>
          <p>{val.gameAddress}</p>
          <div className=" mt-3">
            <a
              className=" mt-3 border border-gray-100 rounded-md p-3"
        ...
        <div className="  flex items-center justify-center  ">
          <p className=" text-3xl font-bold">{val.teamTwoScore}</p>
        </div>
        ...
        <div className=" flex flex-row-reverse flex-1 gap-5 ">
          <div className=" flex  gap-3 justify-center items-center flex-row-reverse">
            <Image
              ...
              alt="team logo"
            />
            <p className=" text-xl font-semibold">{val.teamTwo.teamName}</p>
          </div>
        </div>
      </div>
    )
