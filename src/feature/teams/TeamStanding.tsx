...
export default async function TeamStanding(
	...
	return teamStanding.map(
		(
			standing: TeamsStanding,
			index: number
		) => (
			<TableRow
				key={standing?.id}
			...
			>
				...
				<td className="py-4 px-6 text-left">
					<div className="flex items-center space-x-3">
						...
						<Image
							...
							height={32}
						/>
						<span className="text-white uppercase font-medium text-lg group-hover:text-blue-300 transition-colors">
							{standing.teamName}
						</span>
					</div>
				</td>
				...
				<td className="py-4 px-4 text-center">
					<div className="inline-flex flex-col items-center space-y-1">
						...
						<span className="text-xs text-green-300/70 uppercase tracking-wide">
							Wins
						</span>
					</div>
				</td>
				...
				<td className="py-4 px-4 text-center">
					<div className="inline-flex flex-col items-center space-y-1">
						...
						<span className="text-xs text-red-300/70 uppercase tracking-wide">
							Losses
						</span>
					</div>
				</td>
