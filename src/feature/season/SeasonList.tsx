...
export default function SeasonList(
  ...
  const [data, setData] = useState<Array<Season>>(props.data)
          ...
          <thead className="bg-gray-50">
            <tr>
              ...
              <th
                ...
                onClick={() => requestSort("seasonName")}
              >
                Name {getSortIcon("seasonName:")}
              </th>
              ...
              currentItems.map((item) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <StatusBadge
                      status={item.isActiveSeason ? "Active" : "Inactive"}
                    />
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                    {item.dateCreated}
