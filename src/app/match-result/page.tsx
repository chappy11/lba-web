...
import { Award, BarChart3, Calendar, Target, TrendingUp, Trophy } from "lucide-react"
...
export default async function MatchResultsPage() {
  try {
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-12 text-center">
              ...
              <p className="text-gray-500 text-lg">
                Match results and analysis will appear here once games are completed
              </p>
            </div>
          </div>
        </div>
    ...
    const completedMatches = matchResults.filter(m => m.winner !== "TBA").length
    const averageScore = matchResults.reduce((sum, match) => 
      sum + match.team1Score + match.team2Score, 0) / (totalMatches * 2)
    
    // Get highest scoring game
    const highestScoringGame = matchResults.reduce((highest, current) => {
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-orange-600">
                    {highestScoringGame.team1Score + highestScoringGame.team2Score}
                  </p>
                </div>
            ...
            <div className="bg-gradient-to-r from-orange-500 to-red-500 rounded-2xl shadow-xl p-6 mb-8 text-white">
              ...
              <div className="grid grid-cols-3 gap-4 items-center">
                <div className="text-center">
                  ...
                  <p className="font-bold text-lg">{highestScoringGame.team1}</p>
                  <p className="text-3xl font-bold">{highestScoringGame.team1Score}</p>
                </div>
                <div className="text-center">
                  ...
                  <p className="text-sm opacity-90">
                    {new Date(highestScoringGame.gameDate).toLocaleDateString()}
                  </p>
                </div>
                <div className="text-center">
                  ...
                  <p className="font-bold text-lg">{highestScoringGame.team2}</p>
                  <p className="text-3xl font-bold">{highestScoringGame.team2Score}</p>
                </div>
              </div>
            </div>
          )}
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
            ...
            <div className="divide-y divide-gray-200">
              {sortedResults.map((match, index) => {
                ...
                const winnerScore = isTeam1Winner ? match.team1Score : match.team2Score
                const loserScore = isTeam1Winner ? match.team2Score : match.team1Score
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <p className={`font-semibold ${
                                isTeam1Winner ? "text-green-600" : "text-gray-700"
                              }`}>
                                {match.team1}
                              </p>
                              {isTeam1Winner && (
                      ...
                      <div className="text-right">
                        <div className="flex items-center gap-4">
                          ...
                          <div className={`px-3 py-1 rounded-full text-xs font-medium ${
                            ...
                            {scoreDifference <= 5 ? "Close Game" : 
                             scoreDifference <= 15 ? "Competitive" : "Dominant"}
                          </div>
                        </div>
                      </div>
                    </div>
